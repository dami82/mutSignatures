...
#' Cast a data.frame into a mutationCounts-class object.
#' 
#' @param x a data.frame to be converted to a mutationCounts-class object.
#' 
...
#
# 5. Plot ---------None is working!!!!
#

#' Plot Mutational Signatures
#'
#' @aliases plot,mutationSignatures,ANY-method
#' @docType methods
#' 
#' @param x a mutationSignatures-class object including the mutational signature profile to be plotted
#' @param y not used
#' @param ... additional parameters, such as signature (numeric index of the signature to plot), as well 
#' as other arguments to be passed to the plotMutTypeProfile function
#'
#' @export
setMethod("plot", signature(x = "mutationSignatures", y = "ANY"), 
          function(x, y = NULL, ...) {
...
#' Plot a Mutational Profile from a mutationCounts object
#'
#' @aliases plot,mutationCounts,NULL-method
#' @docType methods
#' 
#' @param x a mutationCounts-class object including the sample whose mutational profile is to be plotted
#' @param y not used
#' @param ... additional parameters to be passed to the plotMutTypeProfile function, including 
#' 'sample' (numeric or string, i.e. the identifier or the index of the sample to be plotted), or
#' 'main' (string to be used as plot title)

#'
#' @export
setMethod("plot", signature(x = "mutationCounts", y="ANY"), 
          function(x, y = NULL, ...) {
            mutCounts <- x
            objOut <- NULL
...
#' Plot MutSignature Exposure Profiles
#'
#' @aliases plot,mutSignExposures,NULL-method
#' @docType methods
#' 
#' @param x a mutSignExposures-class object used to build a 
#' MutSignature Exposure barplot
#' @param y not used
#' @param ... extra arguments to be passed to the plotSignExposures function, 
#' including 'top' (integer, the maximum number of samples to be plotted; 
#' sorted accoding to the mutation burden)
#'
#' @export
setMethod("plot", signature(x = "mutSignExposures", y="ANY"), 
          function(x, y = NULL, ...) {
